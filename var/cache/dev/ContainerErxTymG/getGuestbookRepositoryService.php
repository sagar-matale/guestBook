...
class getGuestbookRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GuestbookRepository.php';

        return $container->privates['App\\Repository\\GuestbookRepository'] = new \App\Repository\GuestbookRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
